...
const SendMessage = () => {
  ...
  return (
    <div className="bg-white p-6 flex flex-col">
      ...
      <Link href={'/chat'} className="bg-heroPrimary hover:bg-Primary transition duration-200 ease-in-out  md:w-[30%] font-semibold text-white text-[18px] sm:text-[18px]  flex items-center justify-around py-2 sm:py-4 px-1 sm:px-8 rounded-lg">
        Отправить SMS
      </Link>
      </div>
